...
Raw protein sequences are not included in this repository due to file size. They can be downloaded from the NCBI Genome database under accession GCF_007990345.1.
